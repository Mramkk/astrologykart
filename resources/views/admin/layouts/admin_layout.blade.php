...
<head>
    ...
    <!-- ============== favicons =========== -->
    <link rel="icon" type="image/png" href="{{ asset('assets/web/img/favicon/favicon.png') }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('a[href="{{ $_SERVER['REQUEST_SCHEME'] }}://' + location.host + location.pathname + '"]')
                .closest('.drop_menu')
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <p class="copyright__content">Copyright © 2022 <a
                                ...
                                href="{{ asset('/') }}">Astrology kart</a> . All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
