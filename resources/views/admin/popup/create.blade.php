            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="html_content" id="" style="height: 400px; width:100%;" class="border px-3"></textarea>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Delay (in Second)</label>
                        <input type="text" class="form-control" name="delay" placeholder="Hint - 5" value="0">
                    </div>
                    <div class="col-sm-4">
