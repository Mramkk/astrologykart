...
@section('head')
    ...
    <title>Astrologer Contact Number | Best Astrologer Contact Number | Top Astrologer Whatsapp & Contact No.</title>
    <meta name="description" content="Register yourself with Astrology Kart and get Consultation with the online best astrologer in India, for instant astrology solutions to your problems.">
    <meta name="keywords" content="Free Astrologer Contact Number, Best Astrologer Contact Number, Top Astrologer Whatsapp & Contact No., Best Astrologer in India Contact Number, Top Jyotish Pandit Contact Number,Astrologer Whatsapp Number in India.">
...
@include('web.includes.breadcrumb',['page_title'=>'Contact Us'])
    ...
    <div class="container">
        ...
        <div class="main__contact--area position__relative">
            ...
            <div class="contact__form">
                <h3 class="contact__form--title mb-40">Message Us</h3>
                <form class="contact__form--inner" action="{{route('contact-enquiry')}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                <label class="contact__form--label" for="input1">First Name <span class="contact__form--label__star">*</span></label>
                                <input class="contact__form--input" name="firstname" id="input1" placeholder="Your First Name" type="text" value="{{old('firstname')}}" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                <label class="contact__form--label" for="input2">Last Name <span class="contact__form--label__star">*</span></label>
                                <input class="contact__form--input" name="lastname" id="input2" placeholder="Your Last Name" type="text" value="{{old('lastname')}}" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                <label class="contact__form--label" for="input3">Phone Number <span class="contact__form--label__star">*</span></label>
                                <input class="contact__form--input" name="mobile" id="input3" placeholder="Phone number" type="text" value="{{old('mobile')}}" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="contact__form--list mb-20">
                                <label class="contact__form--label" for="input4">Email <span class="contact__form--label__star">*</span></label>
                                <input class="contact__form--input" name="email" id="input4" placeholder="Email" type="email" value="{{old('email')}}" required>
                            </div>
                        </div>
                        <div class="col-12">
                ...
                <div class="contact__info--items">
                    ...
                    <div class="contact__info--items__inner d-flex">
                        ...
                        <p class="contact__info--content__desc text-white">Call Us<br>
  							<a href="tel:9608494935">+91 9608494935</a>
  						</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="contact__info--items__inner d-flex">
                        ...
                        <div class="contact__info--content">
                            <p class="contact__info--content__desc text-white">
                    			Mail us<br>
                            	<a href="mailto:info@astrologykart.com">info@astrologykart.com</a></p>
                        </div>
                    </div>
                </div>
                <div class="contact__info--items">
                    ...
                    <div class="contact__info--items__inner d-flex">
                        ...
                        <div class="contact__info--content">
                            <p class="contact__info--content__desc text-white">  Dada complex, N Market Rd, Bhucchar gali, Upper Bazar, Ranchi, Jharkhand 834001</p>
                        </div>
                    </div>
                </div>
                <div class="contact__info--items">
...
<div class="contact__map--area section--padding pt-0 pb-0">
    <iframe class="contact__map--iframe" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14649.436528640941!2d85.3189909!3d23.3752218!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x1c917db87b8105e3!2sAstrology%20Kart-%20Talk%20To%20Astrologer%2C%20Chat%20with%20Astrologer!5e0!3m2!1sen!2sin!4v1659866864745!5m2!1sen!2sin" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
